...
**Remove CP drafts (ADR 2026-08-24) — Validé :** [`cafe-adr/ADR_20260824_remove_cp_drafts.md`](https://github.com/create2-labs/cafe-adr/blob/main/ADR_20260824_remove_cp_drafts.md) — exécution [`ADR_20260824_remove_cp_drafts_PR_PLAN.md`](https://github.com/create2-labs/cafe-adr/blob/main/ADR_20260824_remove_cp_drafts_PR_PLAN.md) (**RD-P\***). Cible : plus de `/drafts*` ; engagement = `POST /policies` signé + `payload_sha256` (JCS) ; W2 sur engagement dès RD-P5. **RD-P1** ✅ contrat OpenAPI / `CP_PERSIST.md` / vecteurs. **RD-P2** : lib [`internal/payloadhash`](../internal/payloadhash/) (JCS + hash ; routes inchangées). **Next :** RD-P4 (challenges stateless) ; RD-P3 (persistence) // possible.
---
